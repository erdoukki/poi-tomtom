...
<table border="1">
  ...
  <tr><td>4 bytes</td><td>L:  length of this record in bytes</td></tr>
...
public class Poi64 extends PoiCommon implements Poi {
	...
	public String toString() {
		return "Poi64 [L:" + length + " u1:" + hex(unknown1) + " ver:0x" + Integer.toHexString(version) + " u2:" + hex(unknown2) + " chc:0x" + Integer.toHexString(check & 0xff) + " u3:" + hex(unknown3) + "]";
	}
}
